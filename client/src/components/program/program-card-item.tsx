...
const ProgramCardItem: FC<Props> = ({ item }) => {
  return (
    <Box
      sx={{
        px: 1,
    ...
    >
      ...
      >
        ...
        >
          <Image src={item.cover} width={760} height={760} alt={'Program ' + item.id} />
        </Box>
        <Box sx={{ mb: 2 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Rating name="rating-program" value={item.rating} max={5} sx={{ color: '#ffce31', mr: 1 }} readOnly />
